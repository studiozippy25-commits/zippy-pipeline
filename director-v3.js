(function(){
  ...
  function renderTabs(state){var tabs=[['setup','1 · SETUP'],['assets','2 · ASSET LOCK'],['geo','3 · SCENE GEO'],['prompt','4 · IMAGE PROMPT'],['qc','5 · QC & LOG']];return '<div class="zv3-tabs">'+tabs.map(function(t){return '<button class="'+(state.activeTab===t[0]?'on':'')+'" onclick="ZippyDirectorV3.setTab(\''+t[0]+'\')">'+t[1]+'</button>';}).join('')+'</div>';}
